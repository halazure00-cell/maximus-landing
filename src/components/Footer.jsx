      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-ui-text-muted text-sm mb-2">
              Ada pertanyaan? Chat langsung via WhatsApp
            </p>
            <a
              href={whatsappUrl}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 text-ui-primary hover:text-ui-primary-hover transition-colors font-medium"
            >
